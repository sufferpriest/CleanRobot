...
/*************************************************************************************************/
  ...
  /**********************************    I2C speed   ************************************/
    ...
    #define I2C_SPEED 400000L   //400kHz fast mode, it works only with some WMP clones //xiaoguo
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define FREEIMUv04      // FreeIMU v0.4 with MPU6050, HMC5883L, MS561101BA                  <- confirmed by Alex  //xiaoguo
...
/*************************************************************************************************/
  /********************************  PID Controller *********************************/
    ...
    //#define ONLYARMWHENFLAT //prevent the copter from arming when the copter is tilted //xiaoguo
